<?php
    ...
    if (isset($_POST['izmeni']) && isset($_POST['id_predmeta'])) {
        $id = $_POST['id_predmeta']; // Uzimamo ID iz POST podataka
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="#" method="post" id="izmeniForm">
                            ...
                            <div class="form-group">
                                <label>Predmet</label>
                                <input id="predmet" type="text" name="predmet" class="form-control" value="<?php echo $prijava->predmet?>" required>
                            </div>
                            <div class="form-group">
                                <label>Katedra</label>
                                <input id="katedra" type="text" name="katedra" class="form-control" value="<?php echo $prijava->katedra?>" required>
                            </div>
                            <div class="form-group">
                                <label>Sala</label>
                                <input id="sala" type="text" name="sala" class="form-control" value="<?php echo $prijava->sala?>" required>
                            </div>
                            <div class="form-group">
                                <label>Datum</label>
                                <input id="datum" type="date" name="datum" class="form-control" value="<?php echo $prijava->datum?>" required>
                            </div>
